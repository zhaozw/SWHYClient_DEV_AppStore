...
extension DaiFileManagerPath {
    ...
    func setAttr(name:String,value:String){
        ...
        do {
            //let docURL = try manager.URLForDirectory(.DocumentDirectory, inDomain:.UserDomainMask, appropriateForURL:nil, create:true)
            ...
            print("Set Attr Fail : ", error)
        }
    }
    
    func getAttr(name:String) -> String{
        var value:String = ""
        do {
            //let docURL = try manager.URLForDirectory(.DocumentDirectory, inDomain:.UserDomainMask, appropriateForURL:nil, create:true)
            //let url = docURL.URLByAppendingPathComponent("example.txt")
...
extension DaiFileManagerPath {
    ...
    var attrs:AnyObject {
        ...
        get {
        //DaiFileManager.defaultManager.a
            return try! DaiFileManager.defaultManager.attributesOfItemAtPath(self.path)
        }
    }
